...
/** Tests for the RunBatchReport sample. */
@RunWith(JUnit4.class)
public class RunBatchReportSampleTest {
  ...
  private String runSample(String ga4PropertyId) throws Exception {
    ...
    RunBatchReportSample.sampleRunBatchReport(ga4PropertyId);
    System.setOut(stdOut);
    return bout.toString();
  }

  @Test
  public void testRunBatchReport() throws Exception {
    // Act
    String out = runSample(ga4PropertyId);

    // Assert
    assertThat(out).contains("Batch report result");
  }
}
