...
/** Tests for the RunReportWithDimensionFilter sample. */
@RunWith(JUnit4.class)
public class RunReportWithDimensionFilterTest {
  ...
  @Test
  public void testRunReportWithDimensionFilter() throws Exception {
    // Act
